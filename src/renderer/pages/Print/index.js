    ...
    return (
      <div className={styles.demoContainer}>
        <Alert
          ...
          message={'点击将【当前窗口】打印到PDF：' + contentPdfPath}
          type="info"
        />
        <Button className={styles.margin} onClick={this.printToPDF}>
          打印
        </Button>
        <Alert
          className={styles.margin}
          message={'点击将【webview】打印到PDF' + webviewPdfPath}
          type="info"
        />
        <Button className={styles.margin} onClick={this.printWebviewToPDF}>
          打印
        </Button>
        ...
        <Alert
          className={styles.margin}
          message="点击将【当前窗口】选择指定打印机进行打印"
          type="success"
        />
        <Button
          className={styles.margin}
          onClick={() => {
            this.contentPrint(false);
          }}
        >
          打印
        </Button>
        ...
        <Alert
          className={styles.margin}
          message="点击将【webview】选择指定打印机进行打印"
          type="info"
        />
        <Button className={styles.margin} onClick={this.printWebview}>
          打印
        </Button>
        <Row className={styles.margin}>
          <webview
